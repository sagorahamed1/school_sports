...
class HandballFScreen extends StatelessWidget {
  const HandballFScreen({super.key});
              ...
              child: Column(
                children: [
                  ...
                  CustomShadowText(
                    top: 20.h,
                    maxline: 20,
                    text: "lequipeSportivedeHandball".tr,
                    fontName: "Puritan",
                    fontsize: 14.h,
                    fontWeight: FontWeight.w700,
                    color: AppColors.whiteFont,
