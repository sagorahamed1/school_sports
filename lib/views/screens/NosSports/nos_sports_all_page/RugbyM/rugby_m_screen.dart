...
class RugbyMScreen extends StatelessWidget {
  const RugbyMScreen({super.key});
              ...
              child: Column(
                children: [
                  ...
                  CustomShadowText(
                    top: 20.h,
                    maxline: 20,
                    text: "lequipeSportivedeRugbe".tr,
                    fontName: "Margarine",
                    fontsize: 14.h,
                    fontWeight: FontWeight.w700,
                    color: AppColors.whiteFont,
                  ...
                  Row(
                    children: [
                      ...
                      const CustomText(
                        left: 7,
                        text: "Gaspard.castaner@ieseg.fr",
                        fontName: "Puritan",
                        color: AppColors.whiteFont,
