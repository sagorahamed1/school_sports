...
class StreetWorkOutScreen extends StatelessWidget {
  const StreetWorkOutScreen({super.key});
              ...
              child: Column(
                children: [
                  ...
                  CustomShadowText(
                    top: 20.h,
                    maxline: 20,
                    text: "lequipeSportiveDeStreetWorkuout".tr,
                    fontName: "Puritan",
                    fontsize: 14.h,
                    fontWeight: FontWeight.w700,
                    color: AppColors.whiteFont,
