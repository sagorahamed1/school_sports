...
class VolleyFScreen extends StatelessWidget {
  const VolleyFScreen({super.key});
              ...
              child: Column(
                children: [
                  ...
                  CustomShadowText(
                    top: 20.h,
                    maxline: 20,
                    text: "lequipeSportiveDeVolleyFeminie".tr,
                    fontName: "Puritan",
                    fontsize: 15.h,
                    fontWeight: FontWeight.w700,
                    color: AppColors.whiteFont,
